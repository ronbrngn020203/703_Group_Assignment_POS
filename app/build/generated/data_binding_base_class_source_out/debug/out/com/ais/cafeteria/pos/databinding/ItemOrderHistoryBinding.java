...
public final class ItemOrderHistoryBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView tvOrderMeta;
  ...
  private ItemOrderHistoryBinding(@NonNull CardView rootView, @NonNull TextView btnViewDetails,
      @NonNull TextView tvOrderId, @NonNull TextView tvOrderMeta, @NonNull TextView tvStatus,
      @NonNull TextView tvTotal) {
    this.rootView = rootView;
    this.btnViewDetails = btnViewDetails;
    this.tvOrderId = tvOrderId;
    this.tvOrderMeta = tvOrderMeta;
  ...
  public static ItemOrderHistoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      TextView btnViewDetails = ViewBindings.findChildViewById(rootView, id);
      ...
      id = R.id.tvOrderMeta;
      TextView tvOrderMeta = ViewBindings.findChildViewById(rootView, id);
      if (tvOrderMeta == null) {
        break missingId;
      }
      ...
      return new ItemOrderHistoryBinding((CardView) rootView, btnViewDetails, tvOrderId,
          tvOrderMeta, tvStatus, tvTotal);
    }
